...
visualise_filtering_tcr_layouts <- function(path_to_outputdir = path_to_outputdir, run_name = run_name, cluster_nodes = 5, path_to_layout = path_to_layout){
	...
	pdf(paste0(path_to_outputdir,'/Plots/Filtering_QC_', Run_name, '.pdf'), width=widthx, height=heightx)
	p4 <- ggplot(Filtering_Results, aes(x=Sample, y=PercentagePassedFiltering, shape=Lane, colour=Library)) + geom_point()  +theme_classic() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % TCRs Passed Filtering") +geom_hline(yintercept=mean(Filtering_Results$PercentagePassedFiltering), col="red", linetype='dotted') +ylim(0,100)+geom_hline(yintercept=(mean(Filtering_Results$PercentagePassedFiltering) + sd(Filtering_Results$PercentagePassedFiltering)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$PercentagePassedFiltering) - sd(Filtering_Results$PercentagePassedFiltering)), col="purple", linetype='dotted') + guides(colour=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	p2 <- ggplot(Filtering_Results, aes(x=Sample, y=N_UniqueTCRS, shape=Lane, colour=Library)) + geom_point()  +theme_classic() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +geom_hline(yintercept=1000, col="blue") +ylab("TCRs: No. Unique Sequences Post-Filtering") +xlab("Sample") + geom_hline(yintercept=mean(Filtering_Results$N_UniqueTCRS), col="red", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$N_UniqueTCRS) + sd(Filtering_Results$N_UniqueTCRS)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$N_UniqueTCRS) - sd(Filtering_Results$N_UniqueTCRS)), col="purple", linetype='dotted') + guides(colour=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	p1 <- ggplot(Filtering_Results, aes(x=Sample, y=PercentageFunctional, shape=Lane, colour=Library)) + geom_point()  +theme_classic() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % Functional") +geom_hline(yintercept=mean(Filtering_Results$PercentageFunctional), col="red", linetype='dotted') +geom_hline(yintercept=(mean(Filtering_Results$PercentageFunctional) + sd(Filtering_Results$PercentageFunctional)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$PercentageFunctional) - sd(Filtering_Results$PercentageFunctional)), col="purple", linetype='dotted')+ylim(0,100) + guides(colour=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	p3 <- ggplot(Filtering_Results, aes(x=Sample, y=Duplication, shape=Lane, colour=Library)) + geom_point()  +theme_classic() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % Unique VDJ nt sequences from Filtered UMIs") +geom_hline(yintercept=mean(Filtering_Results$Duplication), col="red", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$Duplication) + sd(Filtering_Results$Duplication)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$Duplication) - sd(Filtering_Results$Duplication)), col="purple", linetype='dotted') +ylim(0,100)+ guides(colour=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	plot(plot_grid(p1,p3, p2, p4, ncol=1))
	p4 <- ggplot(Filtering_Results, aes(x=reorder(Sample, PercentagePassedFiltering), shape=Lane, colour=Library, y=PercentagePassedFiltering)) + geom_point()  +theme_classic() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % TCRs Passed Filtering") +geom_hline(yintercept=mean(Filtering_Results$PercentagePassedFiltering), col="red", linetype='dotted') +ylim(0,100) +xlab("Sample")  +geom_hline(yintercept=(mean(Filtering_Results$PercentagePassedFiltering) + sd(Filtering_Results$PercentagePassedFiltering)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$PercentagePassedFiltering) - sd(Filtering_Results$PercentagePassedFiltering)), col="purple", linetype='dotted') + guides(colour=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	...
	p1 <- ggplot(Filtering_Results, aes(x=reorder(Sample, PercentageFunctional), shape=Lane, colour=Library, y=PercentageFunctional)) + geom_point()  +theme_classic() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % Functional") +geom_hline(yintercept=mean(Filtering_Results$PercentageFunctional), col="red", linetype='dotted') +ylim(0,100)+xlab("Sample") +geom_hline(yintercept=(mean(Filtering_Results$PercentageFunctional) + sd(Filtering_Results$PercentageFunctional)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$PercentageFunctional) - sd(Filtering_Results$PercentageFunctional)), col="purple", linetype='dotted')+ guides(colour=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	p3 <- ggplot(Filtering_Results, aes(x=reorder(Sample, Duplication), y=Duplication, shape=Lane, colour=Library)) + geom_point()  +theme_classic() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % Unique VDJ nt sequences from Filtered UMIs") +geom_hline(yintercept=mean(Filtering_Results$Duplication), col="red", linetype='dotted') +geom_hline(yintercept=(mean(Filtering_Results$Duplication) + sd(Filtering_Results$Duplication)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$Duplication) - sd(Filtering_Results$Duplication)), col="purple", linetype='dotted')+ylim(0,100)+xlab("Sample")+ guides(colour=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	plot(plot_grid(p1,p3, p2, p4, ncol=1))
	dev.off()
	
	pdf(paste0(path_to_outputdir,'/Plots/Filtering_QC_BATCHCOMPARISON_', Run_name, '.pdf'), width=15, height=heighty)
	# Plot the per batch statistics
	p4 <- ggplot(Filtering_Results, aes(x=Library, y=PercentagePassedFiltering, fill=Library)) + geom_boxplot()  +theme_bw() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % TCRs Passed Filtering") +geom_hline(yintercept=mean(Filtering_Results$PercentagePassedFiltering), col="red", linetype='dotted') +ylim(0,100)+geom_hline(yintercept=(mean(Filtering_Results$PercentagePassedFiltering) + sd(Filtering_Results$PercentagePassedFiltering)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$PercentagePassedFiltering) - sd(Filtering_Results$PercentagePassedFiltering)), col="purple", linetype='dotted') + guides(fill=guide_legend(ncol=4)) +facet_wrap(~Lane, scales = "free_x")
	p2 <- ggplot(Filtering_Results, aes(x=Library, y=N_UniqueTCRS, fill=Library)) + geom_boxplot()  +theme_bw() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +geom_hline(yintercept=1000, col="blue") +ylab("TCRs: No. Unique Sequences Post-Filtering")  + geom_hline(yintercept=mean(Filtering_Results$N_UniqueTCRS), col="red", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$N_UniqueTCRS) + sd(Filtering_Results$N_UniqueTCRS)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$N_UniqueTCRS) - sd(Filtering_Results$N_UniqueTCRS)), col="purple", linetype='dotted') + guides(fill=guide_legend(ncol=4))+facet_wrap(~Lane, scales = "free_x")
	p1 <- ggplot(Filtering_Results, aes(x=Library, y=PercentageFunctional, fill=Library)) + geom_boxplot()  +theme_bw() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % Functional") +geom_hline(yintercept=mean(Filtering_Results$PercentageFunctional), col="red", linetype='dotted') +geom_hline(yintercept=(mean(Filtering_Results$PercentageFunctional) + sd(Filtering_Results$PercentageFunctional)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$PercentageFunctional) - sd(Filtering_Results$PercentageFunctional)), col="purple", linetype='dotted')+ylim(0,100) + guides(fill=guide_legend(ncol=4), shape=guide_legend(ncol=4))+facet_wrap(~Lane, scales = "free_x")
	p3 <- ggplot(Filtering_Results, aes(x=Library, y=Duplication, fill=Library)) + geom_boxplot()  +theme_bw() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % Unique VDJ nt sequences from Filtered UMIs") +geom_hline(yintercept=mean(Filtering_Results$Duplication), col="red", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$Duplication) + sd(Filtering_Results$Duplication)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$Duplication) - sd(Filtering_Results$Duplication)), col="purple", linetype='dotted') +ylim(0,100)+ guides(colour=guide_legend(ncol=4), fill=guide_legend(ncol=4))+facet_wrap(~Lane, scales = "free_x")
	plot(plot_grid(p1,p3, ncol=1))
	plot(plot_grid(p2, p4, ncol=1))
	
	p4 <- ggplot(Filtering_Results, aes(x=Lane, y=PercentagePassedFiltering, fill=Lane)) + geom_boxplot()  +theme_bw() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % TCRs Passed Filtering") +geom_hline(yintercept=mean(Filtering_Results$PercentagePassedFiltering), col="red", linetype='dotted') +ylim(0,100)+geom_hline(yintercept=(mean(Filtering_Results$PercentagePassedFiltering) + sd(Filtering_Results$PercentagePassedFiltering)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$PercentagePassedFiltering) - sd(Filtering_Results$PercentagePassedFiltering)), col="purple", linetype='dotted') + guides(fill=guide_legend(ncol=4)) 
	p2 <- ggplot(Filtering_Results, aes(x=Lane, y=N_UniqueTCRS, fill=Lane)) + geom_boxplot()  +theme_bw() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +geom_hline(yintercept=1000, col="blue") +ylab("TCRs: No. Unique Sequences Post-Filtering") + geom_hline(yintercept=mean(Filtering_Results$N_UniqueTCRS), col="red", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$N_UniqueTCRS) + sd(Filtering_Results$N_UniqueTCRS)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$N_UniqueTCRS) - sd(Filtering_Results$N_UniqueTCRS)), col="purple", linetype='dotted') + guides(fill=guide_legend(ncol=4))
	p1 <- ggplot(Filtering_Results, aes(x=Lane, y=PercentageFunctional, fill=Lane)) + geom_boxplot()  +theme_bw() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % Functional") +geom_hline(yintercept=mean(Filtering_Results$PercentageFunctional), col="red", linetype='dotted') +geom_hline(yintercept=(mean(Filtering_Results$PercentageFunctional) + sd(Filtering_Results$PercentageFunctional)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$PercentageFunctional) - sd(Filtering_Results$PercentageFunctional)), col="purple", linetype='dotted')+ylim(0,100) + guides(fill=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	p3 <- ggplot(Filtering_Results, aes(x=Lane, y=Duplication, fill=Lane)) + geom_boxplot()  +theme_bw() + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1)) +ylab("TCRs: % Unique VDJ nt sequences from Filtered UMIs") +geom_hline(yintercept=mean(Filtering_Results$Duplication), col="red", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$Duplication) + sd(Filtering_Results$Duplication)), col="purple", linetype='dotted')+geom_hline(yintercept=(mean(Filtering_Results$Duplication) - sd(Filtering_Results$Duplication)), col="purple", linetype='dotted') +ylim(0,100)+ guides(fill=guide_legend(ncol=4), shape=guide_legend(ncol=4))
	plot(plot_grid(p1,p3, p2, p4, ncol=2))
	dev.off()	
