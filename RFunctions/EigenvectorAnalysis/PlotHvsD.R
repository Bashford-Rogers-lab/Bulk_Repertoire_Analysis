...
correlate_eigenvectors_hvd <- function(eigenvectors, metadata, outputdir, type_receptor, metahealth, run_all){
	...
	pdf(paste0(outputdir, "/HvsD_AdjModel_Residual_Plot.pdf"), width=(dims+5), height=dims)
	...
	if(interaction_pres =="YES"){
		...
		p_hd_extended_hvsd$Type <- "ADDITIVE MODEL EFFECT"
		...
		pdf(paste0(outputdir, "/HvsD_SimpleEffects_Statistics_", annot, ".pdf"), width=12, height=12)
