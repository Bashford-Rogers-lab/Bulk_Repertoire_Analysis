...
## where the correlation is a repeat measure based on a subset of samples!


Get_subsample_corr_matrix<-function(features, p, min_sample_input, outputdir, iso_type, subsampled_depth_all){
  ...
  saveRDS(file = paste0(outputdir, "Summary/Correlation_between_measures_SUBSAMPLED_", subsampled_depth_all, "_", iso_type,".rds"), mat_feature_corr)
