...
source('/gpfs2/well/immune-rep/shared/CODE/BCR_TCR_PROCESSING_PIPELINE/RFunctions/GeneExpression/GetBestGenes.R')
...
for(i in c("Module_1","Module_2", "Module_3","Module_4", "Module_5", "Module_6", "Module_7", "Module_8", "Module_9", "Module_10", "Module_11", "Module_12", "Module_13", "Module_14", "Module_15", "Module_16", "Module_17", "Module_18", "Module_19", "Module_20", "Module_21", "Module_22", "Module_23", "Module_24", "Module_25",  "Module_26",  "Module_27",  "Module_28",  "Module_29",  "Module_30",  "Module_31")){
	print(i)
	get_best_genes(cohort1_file, cohort2_file, eigenvectors_file, outputdir, cohort_assignment, i)
	}

#### Now lets do the GO analysis
source('/gpfs2/well/immune-rep/shared/CODE/BCR_TCR_PROCESSING_PIPELINE/RFunctions/GeneExpression/GeneOntology.R')
files_LME <- list.files('/gpfs2/well/immune-rep/shared/MISEQ/SEPSIS_COMPLETE/BCR/GeneExpPlots/ALL_GENES/GeneTables/', full.name=TRUE)
