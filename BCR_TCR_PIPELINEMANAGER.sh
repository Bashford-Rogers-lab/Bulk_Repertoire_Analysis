...
if [[ "$STAGE" -eq 4 ]]; then 
	...
	JOB_ID=$(qsub -pe shmem 1 -q short.qc -t 1 -N BCR_TCR_PIPELINE_6 -e COMMANDLOGS/${SAMPLES_FILE_POST}/6/ -o COMMANDLOGS/${SAMPLES_FILE_POST}/6/ -terse BCR_TCR_Wrapper_Cluster.sh ${DEPENDANCIES} ${SAMPLES_FILE_POST} 6)
