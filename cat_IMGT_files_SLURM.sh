...
cd ${CODE_DIRECTORY}
CMD="Rscript ${CODE_DIRECTORY}ISOTYPER_ANALYSIS.R -o ${OUTPUTDIR} -s ${SAMPLES_FILE_POST} -g ${GENE} -l ${LAYOUTS_FILE} -r ${IMGT_MUTATION} -e ${SAMPLES_EXCLUDE} -n ${NORMALISE_VGENEUSAGE}"
echo ${CMD}
eval "${CMD}" 
echo "DONE"
